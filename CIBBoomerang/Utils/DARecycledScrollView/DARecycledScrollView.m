...
- (DARecycledTileView *)visbleTileView
{
    NSArray *tiles = [self.visibleTileViews allObjects];
    NSArray *sortedTiles = [tiles sortedArrayUsingDescriptors:@[[NSSortDescriptor sortDescriptorWithKey:@"index" ascending:NO]]];
    DARecycledTileView *tileView = [sortedTiles lastObject];
    return tileView;
}
